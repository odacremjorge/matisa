    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(to='cliente.Cliente', on_delete=models.CASCADE)),
                ('empleado', models.ForeignKey(to='empleado.Empleado', on_delete=models.CASCADE)),
                ('sucursal', models.ForeignKey(to='sucursal.Sucursal', on_delete=models.CASCADE)),
                ('vehiculo', models.ForeignKey(to='vehiculo.Vehiculo', on_delete=models.CASCADE)),
            ],
            options={
