...
class Venta(models.Model):
	...
	empleado = models.ForeignKey(Empleado,related_name='ventas',on_delete=models.CASCADE)
	#Cliente que realiza la compra
	cliente = models.ForeignKey(Cliente,on_delete=models.CASCADE)
	#Vehiculo de la venta
	sucursal_vehiculo = models.ForeignKey(SucursalVehiculo,related_name='ventas',on_delete=models.CASCADE)
