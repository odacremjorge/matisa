...
class Empleado(models.Model):
	...
	user = models.OneToOneField(User,related_name='empleado',default=None,null=True, on_delete=models.CASCADE)
	...
	imagen = models.ImageField(upload_to = "imagenes/empleado")
